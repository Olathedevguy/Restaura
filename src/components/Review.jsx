  ...
  return (
    <section className="container mx-auto mb-8 mt-12" id="review">
      ...
      className="flex flex-col">
        ...
        className="mb-10 p-10 md:p-0 text-3xl font-light leading-none tracking-tighter lg:mx-40 lg:mt-40 lg:text-[3.5rem]">
          {REVIEW.content}
        </motion.p>
        <motion.div 
        variants={itmeVariants}
      ...
      whileInView= "show"
      variants={itmeVariants}
      viewport={{once : true}} className='mt-14 flex flex-col items-center justify-center gap-2 md:flex-row'>
